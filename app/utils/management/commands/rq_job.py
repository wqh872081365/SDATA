...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        spider_job = spider_status_scheduler.cron(cron_string="0 2 * * *", func=update_user_logs, queue_name="spider_status")
        ...
        default_job_scrapyd = default_scheduler.cron(cron_string="0 5 * * *", func=count_not_finish_user_logs, queue_name="scheduler")
        ...
        args = ["wdata", "proxydb"]
        kwargs = {}
        add_spider_job = add_spider_scheduler.cron(cron_string="0 6 * * *", func=add_schedule, args=args, kwargs=kwargs, queue_name="add_spider")
        ...
        args = []
        kwargs = {}
        proxy_valid_job = proxy_valid_scheduler.cron(cron_string="0 7 * * *", func=set_vaild_proxy, args=args, kwargs=kwargs, queue_name="proxy_valid")
        ...
        args = []
        kwargs = {}
        proxy_invalid_job = proxy_invalid_scheduler.cron(cron_string="0 0 * * 1", func=set_invaild_proxy, args=args, kwargs=kwargs, queue_name="proxy_valid")
